 ...
 */
public class ShangTWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.sporttery.cn/wap/fb/fb_injury.html";
