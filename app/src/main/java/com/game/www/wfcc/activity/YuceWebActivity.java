 ...
 */
public class YuceWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://5.9188.com/yuce/";
...
//                    view.loadUrl(js);
                    String js =  baiduGgJs + funStr + "remaveByClass('fixed kjFloat');remaveByID('userOpsBtn');";
                    view.loadUrl( js);
