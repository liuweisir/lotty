 ...
 */
public class WucAWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.sporttery.cn/wap/list.php?s=fb&sort_id=111";
