 ...
 */
public class KaiJWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.500.com/datachart/ssq/jb.html";
