 ...
 */
public class BsshuoWebActivity2 extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.500.com/lottery/help/index.html";
...
//                    view.loadUrl(js);
                    String js =  baiduGgJs + funStr + "remaveByClass('go-zhishi');";
                    view.loadUrl( js);
