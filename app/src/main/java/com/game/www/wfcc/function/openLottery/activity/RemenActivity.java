 ...
 */
public class RemenActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
    private HanderLayout mHander;
    private WebView webView;
    private String url;
    @Override
    public int bindLayout() {
        return  R.layout.activity_remen_detail;
    }
    public void initHander(){
        this.mHander = (HanderLayout) findViewById(R.id.hander);
        mHander.setTitle("资讯详情");
    ...
    public void initView(View view) {
        ...
        //设置打开的页面地址
        webView.loadUrl("http://mobile.9188.com" + url);
    }
