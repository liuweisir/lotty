...
import com.game.www.wfcc.function.openLottery.adapter.ZiXunAdapter;
 ...
 */
public class ZiXunNewFragment extends BaseFragmentV4 implements OpenLotteryView, HanderLayout.TitleBottonLinstener, XListView.IXListViewListener, AdapterView.OnItemClickListener {


    public static final String TAG = ZiXunNewFragment.class.getSimpleName();
    public static ZiXunNewFragment newInstance() {
        final ZiXunNewFragment f = new ZiXunNewFragment();
        return f;
    }
    ...
    public void initListView(View view){
        mAdapter = new ZiXunAdapter(getActivity());
