...
import com.game.www.wfcc.function.home.JingCaiOpenLanqiuCodeFragment;

/**
 * Created by zhangdaweisir on 2017/6/5.
 */
public class LanqiuActivity extends BaseActivity {
    @Override
    ...
    public void initView(View view) {
        ...
        JingCaiOpenLanqiuCodeFragment fragment = new JingCaiOpenLanqiuCodeFragment();
