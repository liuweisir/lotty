 ...
 */
public class ZiXunFragment extends BaseFragmentV4 implements OpenLotteryView, HanderLayout.TitleBottonLinstener, XListView.IXListViewListener, AdapterView.OnItemClickListener {


    public static final String TAG = ZiXunFragment.class.getSimpleName();
    public static ZiXunFragment newInstance() {
        final ZiXunFragment f = new ZiXunFragment();
        return f;
    }
