 ...
 */
public class XdWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://www.sporttery.cn/wap/specs/tj.html";
...
//                    view.loadUrl(js);
                    String js =  baiduGgJs + funStr + "remaveByClass('m-anoce');";
                    view.loadUrl( js);
