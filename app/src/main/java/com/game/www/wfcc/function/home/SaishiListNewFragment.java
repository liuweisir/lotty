 ...
 */
public class SaishiListNewFragment extends BaseFragmentV4 implements OpenLotteryView {
    public static final String TAG = JingCaiOpenCodeForActivityFragment.class.getSimpleName();
    public static SaishiListNewFragment newInstance() {
        final SaishiListNewFragment f = new SaishiListNewFragment();
        return f;
    }
