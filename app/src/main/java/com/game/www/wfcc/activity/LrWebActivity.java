 ...
 */
public class LrWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.7m.com.cn/bnews/";
...
//                    view.loadUrl(js);
//                    String js =  baiduGgJs + funStr + "remaveByID('btnbuy');remaveByClass('back-link');remaveByClass('right-link')";
//                    view.loadUrl( js);
