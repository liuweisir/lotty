 ...
 */
public class WebActivity2 extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                    view.loadUrl(js);
                    String js =  baiduGgJs + funStr + "remaveByClass('go-zhishi');remaveByClass('buy');";
                    view.loadUrl( js);
