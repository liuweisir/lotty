 ...
 */
public class ZuqiuZsWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.7m.com.cn/news/";
