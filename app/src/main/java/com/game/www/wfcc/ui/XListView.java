...
public class XListView extends ListView implements OnScrollListener,NestedScrollingChild {
	...
	public void setHeaderViewColor(int r){
		mHeaderView.setBackgroundResource(r);
	...
	public void setPullLoadNoMore(boolean noMore) {
	...
	public void stopLoadMore() {
		if (mPullLoading == true) {
			mPullLoading = false;
			//mFooterView.setState(XListViewFooter.STATE_NORMAL);2017-1-5
		}
	}
