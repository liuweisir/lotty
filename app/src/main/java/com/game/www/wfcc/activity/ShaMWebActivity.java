 ...
 */
public class ShaMWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.aicai.com/f/filterCode.do?gameId=101&agentId=1&vt=5";
