...
public class MainInitFrgmentLinstener implements HomeTabLayout.InitFrgmentLinstener {
    ...
    public void messageLinstener() {
        ...
        HomeAFragment openLotteryFragment = (HomeAFragment) fragmentManager.findFragmentByTag(HomeFragment.TAG);

        if (openLotteryFragment == null) {
//            openLotteryFragment = WebFragment.newInstance("https://m.ydniu.com/open/", "开奖", false, 20 , 20);
...
//            jingCaiOpenCodeFragment = WebFragment.newInstance("http://m.cubegoal.com/cube/", "魔方", false, 0 , -130);
