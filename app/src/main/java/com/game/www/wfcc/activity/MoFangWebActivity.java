 ...
 */
public class MoFangWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.cubegoal.com/cube/";
...
//足球魔方很难调试
                    mHander.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            view.loadUrl( jsStr + "remaveByClass('page');remaveByClass('div_table buybar2');remaveByClass('fixfooter');remaveByClass('m-latematch');remaveByClass('all-download');remaveByClass('m-header');remaveByClass('news-content');remaveByClass('train-content');remaveByClass('news-panel');$('div.detail-ad').children('a').css('display','none');remaveByClass('fixed kjFloat');remaveByClass('ops-btn');remaveByClass('m-header');remaveByClass('news-content');remaveByClass('train-content');remaveByClass('news-panel');");
