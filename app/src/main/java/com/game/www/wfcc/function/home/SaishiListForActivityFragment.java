 ...
 */
public class SaishiListForActivityFragment extends BaseFragmentV4 implements OpenLotteryView, HanderLayout.TitleBottonLinstener {
    public static final String TAG = JingCaiOpenCodeForActivityFragment.class.getSimpleName();
    public static SaishiListForActivityFragment newInstance() {
        final SaishiListForActivityFragment f = new SaishiListForActivityFragment();
        return f;
    }
