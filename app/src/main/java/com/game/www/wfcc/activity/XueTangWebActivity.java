 ...
 */
public class XueTangWebActivity extends BaseActivity implements HanderLayout.TitleBottonLinstener {
...
//                handerLayout.setTitle(title);
        ...
        objectUrl = "http://m.cp.360.cn/activity/jcappxt?reffer=wap";
